...
void CgAABB::setVertices(float x_min, float x_max, float y_min, float y_max, float z_min, float z_max) {
    // Vorderseite
...
void CgAABB::init( std::vector<glm::vec3> arg_verts,  std::vector<glm::vec3> arg_normals, std::vector<unsigned int> arg_triangle_indices)
{
    m_vertices.clear();
    m_vertex_normals.clear();
    m_triangle_indices.clear();
...
void CgAABB::init( std::string filename)
{
    m_vertices.clear();
    m_vertex_normals.clear();
    m_triangle_indices.clear();
...
const std::vector<glm::vec3>& CgAABB::getVertices() const
{
    return m_vertices;
}

const std::vector<glm::vec3>& CgAABB::getVertexNormals() const
{
    return m_vertex_normals;
}

const std::vector<glm::vec3>& CgAABB::getVertexColors() const
{
     return m_vertex_colors;
}

const std::vector<glm::vec2>& CgAABB::getVertexTexCoords() const
{
    return m_tex_coords;
}

const std::vector<unsigned int>& CgAABB::getTriangleIndices() const
{
    return m_triangle_indices;
}

const std::vector<glm::vec3>& CgAABB::getFaceNormals() const
{
    return m_face_normals;
}

const std::vector<glm::vec3>& CgAABB::getFaceColors() const
{
    return m_face_colors;
}

const std::vector<glm::vec3>& CgAABB::getFaceCentroid() const
{
