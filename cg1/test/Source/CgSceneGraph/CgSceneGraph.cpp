...
CgSceneGraph::CgSceneGraph()
{
    ...
    glm::mat4 matrix_cube = { glm::vec4(1.0,  0.0,  0.0,  0.0),
                           ...
                           glm::vec4(0.0,  0.0, 1, 0.0),
                           glm::vec4(1.5,  1.5,  1.5,  1)};

    glm::mat4 matrix_triangle1 = { glm::vec4(3,  0.0,  0.0,  0.0),
                                  glm::vec4(0.0, 3,  0.0,  0.0),
                                  glm::vec4(0.0,  0.0, 3, 0.0),
                                  glm::vec4(0.0, 0.0, 0.0,  1)};

    glm::mat4 matrix_triangle2 = { glm::vec4(1,  0.0,  0.0,  0.0),
                                  glm::vec4(0.0, 1,  0.0,  0.0),
                                  glm::vec4(0.0,  0.0, 1, 0.0),
                                  glm::vec4(-1.5,  -1.5,  -1.5,  1)};
...
void CgSceneGraph::iterateAllChildren_DFS(CgSceneGraphEntity* node)
{
    ...
    for(unsigned int i = 0; i < node->getListOfObject().size(); i++) {
//        renderer->init(this->getListOfObject().at(i));
        m_renderer->render(node->getListOfObject().at(i));
    }
