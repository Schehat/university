...
if (document.getElementById("currentBMI").innerHTML < 18.5) {
    document.getElementById("ergebnis").innerHTML = "Sie sind untergewichtig (< 18,5) !";
} else if (document.getElementById("currentBMI").innerHTML > 25){
    document.getElementById("ergebnis").innerHTML = "Sie sind übergewichtig (25 bis 29,9) !";
} else {
    document.getElementById("ergebnis").innerHTML = "Sie sind normalgewichtig (18,5 bis 24,9) !";
}
